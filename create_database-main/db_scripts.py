...
def create():
    open()
    cursor.execute('''PRAGMA foregion_keys=on''')

    do('''GREATE TABLE IF NOT EXISTS quiz(
    ...
    do('''CREATE TABLE IF NOT EXISTS quiz_content(
          ...
          quiz_id INTEGER,
          question_id INTEGER,
          FOREIGIN KEY(quiz_id) REFERENCES quiz(id)
          FOREIGN KEY(question_id) REFERENCES qestions(id) )''')
    close()
...
def add_question():
 ...
 open()
 cursor.executeamy('''INSERT INTO question)
